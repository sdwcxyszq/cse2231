...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <-2,-5,-3,5> and s2 = <13, 17, 11>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-2, -5, -3, 5);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-2, -5, -3, 5);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-3, -4, 1);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void test4() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-2, -5);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-2, -5);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11);
    ...
    /**
     * Test smooth with s1 = <2147483647, 2147483647> and s2 = <13, 17, 11>.
     */
    @Test
    public void test5() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(2147483647, 2147483647);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(2147483647,
                2147483647);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(2147483647);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
